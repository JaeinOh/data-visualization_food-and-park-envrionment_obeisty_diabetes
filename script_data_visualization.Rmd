...
#refer research paper "Spatially-varying effects of built environment determinants on walking" when writing decription of maps in word document (coefficients for obesity and variables, coefficients for diabetes and variables)
